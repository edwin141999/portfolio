...
export default function Header() {
  ...
  const renderThemeChanger = () => {
    ...
    if (theme === 'dark') {
      return (
        <div className="flex text-yellow-500 gap-5 border-2 border-yellow-500 px-2 py-1 rounded-md md:w-44 md:justify-between group hover:bg-yellow-500 duration-500" role="button" onClick={() => setTheme('light')}>
          <p className="hidden md:flex group-hover:text-white duration-500">Modo Claro</p>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 group-hover:text-white duration-500">
      ...
      return (
        <div className="flex text-gray-900 gap-5 border-2 border-gray-900 px-2 py-1 rounded-md md:w-44 md:justify-between group hover:bg-black duration-500" role="button" onClick={() => setTheme('dark')} >
          <p className="hidden md:flex group-hover:text-white duration-500">Modo Oscuro</p>
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 group-hover:text-white duration-500">
