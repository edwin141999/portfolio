      ...
      <div className="w-full py-8 bg-gradient-to-r from-rose-400 via-fuchsia-500 to-indigo-500">
        ...
        <div className="flex items-center justify-center px-10 pt-5">
          ...
          <div className="flex sm:justify-center">
            <Link href={'https://github.com/edwin141999'} className="text-white hover:text-slate-900 ms-10">
            ...
            <Link href={'https://www.linkedin.com/in/edwindavila/'} className="text-white hover:text-slate-900 ms-10">
