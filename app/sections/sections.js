...
export default function Projects() {
  ...
  return (
    <>
      ...
      <section className="grid grid-cols-2 md:grid-cols-10 auto-rows-[25rem] gap-12 2xl:gap-x-24 w-full min-h-screen mx-auto p-20 bg-gray-200 dark:bg-slate-900 dark:text-white">
